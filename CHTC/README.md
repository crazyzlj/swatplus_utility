...
+ 登录CHTC，将sif镜像文件上传至`/staging/lzhu267`
+ 创建目录`/home/lzhu267/swatplus_proj/single_exec`
...
+ singlerun
++ 提交作业命令：condor_submit SWATPlusVer=61.0.2.61-133-gb5735fd-gnu-lin_x86_64-Rel-o1 ParamFile=blank.cal ResultDir=gnu-rel-o1  worker.sub